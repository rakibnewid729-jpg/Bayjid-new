    ...
    try {         
        ...
        if (body.startsWith("baby") || body.startsWith("bby") || body.startsWith("bot") || body.startsWith("jan") || body.startsWith("babu") || body.startsWith("janu")) {             
            ...
            const randomReplies = [
                ...
                "😹 আরে বাবা, আবার আইসোস কেন?",
                "🤬 কথা কম বল, না হলে ব্লক মারবো!",
                "😆 তোরে দেখলেই হাসি পায়!",
                "😂 তুই না থাকলে দুনিয়া শান্তিতে থাকতো!",
                "😜 কি রে, আবার কি চাই?",
                "😒 বিরক্ত করিস না রে!",
                "🙃 আহারে, একলা লাগে নাকি?",
                "🤭 হাহাহা, একদম পাগল টাইপ!",
                "🤣 চুপ থাক, মাথা খাইস না!",
                "😈 ওরে বাবা, ভয় পাইলাম!",
                "🤪 উফফ, তোরে সহ্য করা যায় না!",
                "🥵 একদম গরম লাগাই দিস!",
                "🙆‍♂️ ধুর মিয়া, অযথা বকিস না!",
                "😴 ঘুম আসতেছে, পরে আয়!",
                "🤔 হুম, কি বুঝাইতে চাইছিস?"
            ];
