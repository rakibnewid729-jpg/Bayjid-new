// set bash title
process.stdout.write("\x1b]2;MALVINA BOT V2 - Made by BaYjid\x1b\x5c");
...
const titles = [
	...
	[
		"M A L V I N A B O T V2 @" + currentVersion
	],
	[
		"MALVINABOT V2"
	]
...
let subTitle = `MALVINA BOT@${currentVersion}- A simple Bot chat messenger use personal account`;
const subTitleArray = [];
...
async function startBot(loginWithEmail) {
	...
	(function loginBot(appState) {
		...
		login({ appState }, global.GoatBot.config.optionsFca, async function (error, api) {
			...
			console.log(`\x1b[1m\x1b[33m${("COPYRIGHT:")}\x1b[0m\x1b[1m\x1b[37m \x1b[0m\x1b[1m\x1b[36m${("Project GoatBot v2 created by BaYjid (https://github.com/BAYJID-00), please do not sell this source code or claim it as your own. Thank you!")}\x1b[0m`);
			logColor("#f5ab00", character);
